      ...
      <section className="w-[100vw] h-[100vh] page4 bg-cover select-none">
        ...
        <div className="w-1/2 -mt-14 ml-[650px] flex flex-col gap-4 text-justify text-white text-lg font-medium">
          <p>
            ...
            research, as well as for India. Modiji has rightly named 23 August
            as National Space Day. But first let me tell you a small story about
          ...
          <p>
            ...
            foolish wish. He promised a huge reward for anyone who would please
            his daughter. Many courtiers came forward with various ideas but
            none could please the princess.
          </p>
          <p>
